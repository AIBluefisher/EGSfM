#ifndef GEOMETRY_RANSAC_SIMILARITY_H
#define GEOMETRY_RANSAC_SIMILARITY_H
...
public:
                       ...
                       std::vector<Sim3>* models) const
    {
        ...
        openMVG::geometry::FindRTS(x1, x2, &model.s, &model.t, &model.R);
        // openMVG::geometry::Refine_RTS(x1, x2, &model.s, &model.t, &model.R);
